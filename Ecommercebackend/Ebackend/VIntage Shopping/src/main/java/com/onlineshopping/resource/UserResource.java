...
//		User addUser = userDao.save(user);
		...
		String subject = "E-commerce Vintage Shopping - Verify Your Email Address for User Registration";
...
//		}
		...
		String subject = "E-commerce Vintage Shopping - Verify OTP for Forget Password";
