...
const Product = () => {
  ...
  const retrieveProduct = async () => {
    const response = await axios.get(
      "http://localhost:8000/api/product/id?productId=" + productId
    );
  ...
  const saveProductToCart = (userId) => {
    fetch("http://localhost:8000/api/user/cart/add", {
      method: "POST",
      headers: {
      ...
      <div class="row">
        ...
        <div class="col-sm-3 mt-2 admin">
          <div class="card form-card border-color custom-bg">
            <img
              src={"http://localhost:8000/api/product/" + product.imageName}
              style={{
                maxHeight: "500px",
                maxWidth: "100%",
                width: "auto",
