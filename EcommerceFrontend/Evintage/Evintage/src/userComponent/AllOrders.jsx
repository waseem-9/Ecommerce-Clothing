...
//       "http://localhost:8000/api/user/admin/allorder"
//     );
...
const AllOrders = () => {
  ...
  return (
    <div className="allmt-3">
      <div
        className="allcard allform-card allms-2 allme-2 allmb-5 allcustom-bg allborder-color"
        style={{
          height: "45rem",
        }}
      >
        <div className="allcard-header allcustom-bg-text alltext-center allbg-color">
          <h2>All Orders</h2>
        </div>
        <div
          className="allcard-body"
          style={{
            overflowY: "auto",
          }}
        >
          <div className="alltable-responsive">
            <table className="alltable alltable-hover alltext-center">
              <thead className="alltable-bordered allborder-color allbg-color allcustom-bg-text">
                <tr>
                  <th scope="col">Order Id</th>
                  <th scope="col">Product</th>
                  <th scope="col">Name</th>
