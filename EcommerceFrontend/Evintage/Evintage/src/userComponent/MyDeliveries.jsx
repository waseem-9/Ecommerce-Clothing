...
//       "http://localhost:8000/api/user/delivery/myorder?deliveryPersonId=" +
//         delivery.id
//     );
...
const MyDeliveries = () => {
  ...
  return (
    <div className="mdmt-3">
      <div
        className="mdcard mdform-card mdms-2 mdme-2 mdmb-5 mdcustom-bg mdborder-color"
        style={{
          height: "45rem",
        }}
      >
        <div className="mdcard-header text-center mdbg-color mdcustom-bg-text">
          <h2>My Deliveries</h2>
        </div>
        <div
          className="mdcard-body"
          style={{
            overflowY: "auto",
          }}
        >
          <div className="mdtable-responsive">
            <table className="mdtable mdtable-hover mdcustom-bg-text text-center">
              <thead className="mdbg-color mdtable-bordered mdborder-color">
                <tr>
                  <th scope="col">Order Id</th>
                  <th scope="col">Product</th>
                  <th scope="col">Name</th>
